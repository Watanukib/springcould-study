...
//    public static final String PRODUCT_ADD_URL = "http://localhost:8080/prodcut/add/";
    public static final String PRODUCT_GET_URL = "http://MICROCOULD-PRODUCT/prodcut/get/";
    public static final String PRODUCT_LIST_URL="http://MICROCOULD-PRODUCT/prodcut/list/";
    public static final String PRODUCT_ADD_URL = "http://lMICROCOULD-PRODUCT/prodcut/add/";
    @Resource
    ...
    public  Object listProduct() {
        ServiceInstance choose = this.loadBalancerClient.choose("MICROCOULD-PRODUCT");
        System.out.println("----choose----host = "+choose.getHost()
                            +"、post = "+choose.getPort()
